  \subsection{Medición de potencia activa y factor de potencia} 
    ...
    semiperiodo de la tensión de entrada y la diferencia en segundos entre las señales
    ...
    \begin{figure}[H]
      ...
      \begin{subfigure}[h]{0.4\textwidth}
        ...
        \caption{Semiperiodo en segundos.}
      ...
      \begin{subfigure}[h]{0.4\textwidth}
        \centering
        \frame{\includegraphics[width=\textwidth]{Imagenes/ActividadPractica/MedicionDePotenciasYFdP/Exp1_2_DiferenciaDeFaseEnSegundos.png}}
        \caption{Desfase en seg. de las señales.}
    ...
    Figura~\ref{fig:DesfaseConLissajous}. En base a la ecuación (XXXXXXXXX) se calcula el valor del ángulo
    ...
    \begin{figure}[H]
      ...
      \begin{subfigure}[h]{0.4\textwidth}
        ...
        \caption{Valores de corte del eje vertical.}
      ...
      \begin{subfigure}[h]{0.4\textwidth}
        ...
        \caption{Valores máximos del eje vertical.}
    ...
    Una vez realizadas las mediciones se calculan la potencia activa \textbf{P}, reactiva \textbf{Q} y aparente \textbf{S}, con el uso de las ecuaciones (XXX),
