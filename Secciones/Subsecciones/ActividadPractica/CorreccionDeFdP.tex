  \subsection{Correción del factor de potencia}
    ...
    \subsubsection{Medicion del factor de potencia corregido}
        ...
        \begin{figure}[H]
          \centering
          \frame{\includegraphics[width=0.7\textwidth]{Imagenes/ActividadPractica/CorreccionDeFdP/Exp2_11_Vin-Iin-ConCapacitor.png}}
        ...
        \begin{figure}[H]
          \centering
          \frame{\includegraphics[width=0.7\textwidth]{Imagenes/ActividadPractica/CorreccionDeFdP/Exp2_15_Vin-Iin-ConCapacitorYFiltroEnOsc.png}}
